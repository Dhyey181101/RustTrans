...
def test():
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        src_dir = "bms/c/libopenaptx/aptx_check_parity"
        submodule_name = "aptx_check_parity"
        oracle.instrument("c", src_dir, submodule_name, workspace)

        validation_result = oracle.verify(workspace, submodule_name, workspace)
        if validation_result:
            positives, negatives=validation_result
