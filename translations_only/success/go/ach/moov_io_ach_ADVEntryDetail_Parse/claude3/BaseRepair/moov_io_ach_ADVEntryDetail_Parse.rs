...
impl MoovIoAchAdvEntryDetail {
    fn parse(&mut self, record: &str) {
        ...
        self.dfi_account_number = Box::new(record[12..27].to_owned());
        ...
        self.individual_name = Box::new(record[54..76].to_owned());
        // 77-78 allows ODFIs to include codes of significance only to them, normally blank
        self.discretionary_data = Box::new(record[76..78].to_owned());
