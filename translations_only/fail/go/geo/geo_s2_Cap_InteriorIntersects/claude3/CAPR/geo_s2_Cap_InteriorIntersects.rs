...
fn geo_s2_cap_interior_intersects(c: Box<geo_s2_Cap>, other: Box<geo_s2_Cap>) -> bool {
...
fn geo_s2_chord_angle_between_points(x: &geo_s2_Point, y: &geo_s2_Point) -> f64 {
    let v = geo_r3_vector_sub(&x.geo_r3_vector, &y.geo_r3_vector);
    geo_r3_vector_norm2(&v).min(GEO_S1_MAX_LENGTH2)
}
