...
fn approx_equal(i: &GeoS1Interval, other: &GeoS1Interval) -> bool {
    ...
    (f64::abs(((other.lo - i.lo) % (2.0 * std::f64::consts::PI)).rem_euclid(2.0 * std::f64::consts::PI)) <= GEO_S1_EPSILON &&
     f64::abs(((other.hi - i.hi) % (2.0 * std::f64::consts::PI)).rem_euclid(2.0 * std::f64::consts::PI)) <= GEO_S1_EPSILON &&
