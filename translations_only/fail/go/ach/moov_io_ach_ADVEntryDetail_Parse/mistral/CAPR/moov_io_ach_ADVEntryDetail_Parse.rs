...
const CHECKING_DEBIT: u8 = 27;
const SAVINGS_CREDIT: u8 = 32;
const SAVINGS_DEBIT: u8 = 37;
const GL_PRENOTE_DEBIT: u8 = 48;
const LOAN_PRENOTE_CREDIT: u8 = 53;
const LOAN_ZERO_DOLLAR_REMITTANCE_CREDIT: u8 = 54;
const CREDIT_SUMMARY: u8 = 87;
